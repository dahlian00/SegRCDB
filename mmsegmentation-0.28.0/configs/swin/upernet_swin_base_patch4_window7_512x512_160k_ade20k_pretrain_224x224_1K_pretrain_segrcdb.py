_base_ = [
    ...
    'pretrain_224x224_1K_pretrain_segrcdb.py'
]
...
model = dict(
    backbone=dict(
        ...
        depths=[2, 2, 18, 2],
        num_heads=[4, 8, 16, 32]),
    decode_head=dict(in_channels=[128, 256, 512, 1024], num_classes=255),
    auxiliary_head=dict(in_channels=512, num_classes=255))